...
const _VIEW_MAP = {
  ...
  "admin":       "modules/admin/view.html?v=6.31.1",
  "pext":        "modules/admin/view.html?v=6.31.1",
  "fin":         "modules/financeiro/view.html?v=6.31.1",
  "cnab":        "modules/financeiro/view.html?v=6.31.1",
  "jur":         "modules/juridico/view.html?v=6.31.1",
  "conselho":    "modules/conselho/view.html?v=6.31.1",
  "atas":        "modules/conselho/view.html?v=6.31.1",
  "pautas":      "modules/conselho/view.html?v=6.31.1",
  "pastoral":    "modules/pastoral/view.html?v=6.31.1",
  "min":         "modules/departamentos/view.html?v=6.31.1",
  "agenda":      "modules/agenda/view.html?v=6.31.1",
  "pgs":         "modules/pgs/view.html?v=6.31.1",
  "infra":       "modules/infraestrutura/view.html?v=6.31.1",
  "dem":         "modules/demandas/view.html?v=6.31.1",
  "rel":         "modules/relatorios/view.html?v=6.31.1",
  "memb":        "modules/membresia/view.html?v=6.31.1",
  "proj":        "modules/projetos/view.html",
  "diac":        "modules/diaconal/view.html?v=6.31.1",
  "cong":        "modules/congregacoes/view.html",
  "com":         "modules/comunicacao/view.html?v=6.31.1",
  "eve":         "modules/eventos/view.html?v=6.31.1",
  "area":        "modules/area-membro/view.html?v=6.31.1",
  "config":      "modules/config/view.html",
  "generic":     "modules/shared/view.html",
  "acesso":      "modules/acesso/view.html?v=6.31.1",
};

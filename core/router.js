...
const CRUMB={
  ...
  "recursos-dash": ["Recursos","Dashboard","/ estoque, requisições e movimentações"],
  "recursos-lista":["Recursos","Itens e Estoque","/ todos os itens cadastrados"],
  ...
  "compras-dash":    ["Compras","Dashboard","/ pedidos, cotações e aprovações"],
  ...
  "fin-dizimos-ofertas":["Financeiro","Dízimos e Ofertas","/ registro e campanhas de arrecadação"],
  "fin-dizimos":["Dízimos e Ofertas","Dízimos","/ registro e histórico de dizimistas"],
  "fin-ofertas":["Dízimos e Ofertas","Ofertas","/ ofertas regulares e campanhas especiais"],
  "fin-ofertas-especiais":["Ofertas","Ofertas Especiais","/ campanhas com meta, período e link público"],
  "fin-oe-campanhas":["Ofertas Especiais","Campanhas","/ todas as campanhas"],
  "fin-oe-contribuicoes":["Ofertas Especiais","Contribuições","/ registros e conciliação"],
  "fin-oe-conciliacao":["Ofertas Especiais","Conciliação","/ confirmar e vincular ao financeiro"],
  "fin-oe-relatorios":["Ofertas Especiais","Relatórios","/ por campanha e período"],
  ...
  "conselho-resolucoes":["Conselho e Governança","Resoluções do Conselho","/ deliberações normativas"],
  ...
  "pautas-reunioes":        ["Conselho e Governança","Reuniões do Conselho","/ reuniões"],
  "pautas-pautas":          ["Conselho e Governança","Reuniões do Conselho","/ pautas"],
  ...
  "pastoral-proculto":      ["Pastoral","Pró-Culto","/ central operacional dos cultos"],
  "pastoral-rede":          ["Pastoral","Rede de Cuidado","/ acompanhamento e cuidado"],
  "pastoral-whatsapp":      ["Pastoral","WhatsApp — Pastoral","/ mensagens automáticas"],
...
const _VIEW_MAP = {
  ...
  "fin":         "modules/financeiro/view.html?v=6.67.0",
  "cnab":        "modules/financeiro/view.html?v=6.67.0",
  ...
  "pastoral":    "modules/pastoral/view.html?v=6.46.1",
  "min":         "modules/departamentos/view.html?v=6.49.99",
  "agenda":      "modules/agenda/view.html?v=6.45.13",
  ...
  "dep":         "modules/dep-adm/view.html",
  "recursos":    "modules/recursos/view.html",
  "compras":     "modules/compras/view.html",
  "proculto":    "modules/pastoral/view.html?v=6.46.1",

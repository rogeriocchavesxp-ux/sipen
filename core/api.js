...
const SCHEMA = {
  ...
  tipos: {
    AGENDA:     { data:"date", hora_inicio:"time", hora_fim:"time", status:"select:confirmado,pendente,cancelado,reagendado", recorrencia:"select:Semanal,Quinzenal,Mensal,Anual", espaco:"espacos-select" },

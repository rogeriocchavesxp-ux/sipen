...
const SCHEMA = {
  ...
  tipos: {
    AGENDA:     { tipo:"select:Culto,Reunião,Ensaio,Congresso,Conferência,Evento,Casamento,Aniversário,Outros", data:"date", hora_inicio:"time", hora_fim:"time", dia_semana:"select:Domingo,Segunda-feira,Terça-feira,Quarta-feira,Quinta-feira,Sexta-feira,Sábado", mes:"select:Janeiro,Fevereiro,Março,Abril,Maio,Junho,Julho,Agosto,Setembro,Outubro,Novembro,Dezembro", status:"select:pendente=Pendente,aguardando_aprovacao=Aguardando Aprovação,em_analise=Em Análise,ajuste_solicitado=Ajuste Solicitado,confirmado=Confirmado,realizado=Realizado,reagendado=Reagendado,cancelado=Cancelado,recusado=Recusado,arquivado=Arquivado", recorrencia:"select:Único,Semanal,Quinzenal,Mensal,Anual,Data Especial", espaco:"espacos-multi" },

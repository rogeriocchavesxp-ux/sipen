...
const SCHEMA = {
  ...
  tipos: {
    ...
    MEMBROS:    { status:"select:ativo,inativo,transferido,falecido,disciplinado,afastado", tipo_membro:"select:comungante=Comungante,nao_comungante=Não Comungante", data_nascimento:"date", data_ingresso:"date", data_saida:"date", data_batismo:"date", batizado:"boolean", casado_na_igreja:"boolean", tipo_ingresso:"select:batismo,transferencia=Transferência,profissao_de_fe=Profissão de Fé,restauracao=Restauração,outro", congregacao:"congregacoes-select" },

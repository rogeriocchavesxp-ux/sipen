...
const _shellReady = _isPublicRoute ? Promise.resolve() : Promise.all([
  fetch("views/login.html?v=6.41.2").then(r => r.ok ? r.text() : ""),
  fetch("views/sidebar.html?v=6.41.2").then(r => r.ok ? r.text() : ""),
  fetch("views/modals.html?v=6.41.2").then(r => r.ok ? r.text() : ""),

...
const _shellReady = Promise.all([
  fetch("views/login.html?v=6.30.96").then(r => r.ok ? r.text() : ""),
  fetch("views/sidebar.html?v=6.30.96").then(r => r.ok ? r.text() : ""),
  fetch("views/modals.html?v=6.30.96").then(r => r.ok ? r.text() : ""),

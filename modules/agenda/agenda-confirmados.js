...
async function agCarregarConfirmados() {
  ...
  try {
    const url = `${apiBaseUrl()}/rest/v1/agenda?status=eq.confirmado&deleted_at=is.null&or=(recorrencia.neq.Data%20Celebrativa,recorrencia.is.null)&order=data.desc&select=*`;

...
const DEPT_ADM = (function(){
  ...
  const CFG = [
    ...
    { slug:'infraestrutura', nome:'Patrimônio', ico:'🔧', cor:'var(--violet)', desc:'Manutenção, conservação e espaços físicos' },
  ];
  ...
  function _renderLista(){
    ...
    if(heroDsc) heroDsc.textContent = "Secretaria, Tesouraria, Patrimônio, Comunicação, Jurídico";
